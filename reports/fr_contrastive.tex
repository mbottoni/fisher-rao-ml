...
noise-tolerance bound, and present preliminary results on UCI Digits under synthetic
false-negative injection (null result at this scale: the dataset is too easy for
false negatives to matter). CIFAR-10/ImageNet-scale evaluation is identified as the
key remaining experiment.
\end{abstract}
